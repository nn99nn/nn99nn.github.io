  ...
  categories: [
    ...
    // ── 點心 ──────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        {
          id: 'ds-06',
          name: { zh: '醬皇蒸鳳爪（例）', en: 'Steamed Chicken Feet in House Signature Sauce (per portion)', ja: '特製醤汁蒸し鶏の爪（1人前）' },
          price: 220,
          desc:  { zh: '', en: '', ja: '' },
          image: '', youtube: '', badge: [],
        },
        ...
        {
          id: 'ds-10',
          name: { zh: 'XO醬炒蝦米腸（例）', en: 'Cheung Fun Stir-Fried with XO Sauce & Dried Shrimp (per portion)', ja: 'XOソース干し海老炒め腸粉（1人前）' },
          price: 360,
          desc:  { zh: '', en: '', ja: '' },
        ...
        {
          id: 'ds-11',
          name: { zh: '脆皮海皇腸粉（例）', en: 'Crispy Seafood Cheung Fun (per portion)', ja: 'クリスピー海鮮腸粉（1人前）' },
          price: 350,
          desc:  { zh: '', en: '', ja: '' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'ds-12',
          name: { zh: '香菜叉燒腸粉（例）', en: 'Cilantro & Char Siu Cheung Fun (per portion)', ja: 'パクチーと叉焼腸粉（1人前）' },
          price: 300,
          desc:  { zh: '', en: '', ja: '' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'ds-13',
          name: { zh: '金耳素菌腸粉（例）', en: 'Golden Ear Fungus & Mushroom Vegetarian Cheung Fun (per portion)', ja: '金耳きのこの精進腸粉（1人前）' },
          price: 280,
          desc:  { zh: '', en: '', ja: '' },
          image: '', youtube: '', badge: ['veg'],
        },
    ...
    // ── 燒味 ──────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        },
        {
          ...
          price: null,
          desc:  {
            zh: '捌伍叉燒皇・瑤柱貴妃雞・潮蓮靚燒鵝・化皮烤乳豬（加價 $200）　二款 $1,480　三款 $1,580',
            en: '85TD Char Siu · Conpoy Poached Chicken · Teochew Roasted Goose · Crispy Suckling Pig (+NT$200)　2 Items NT$1,480　3 Items NT$1,580',
            ja: '叉焼皇・干し貝柱仕立て貴妃鶏・潮州焼きガチョウ・クリスピー仔豚ロースト（+NT$200）　2種 NT$1,480　3種 NT$1,580',
          },
          image: '', youtube: '', badge: [],
        },
        {
        ...
        },
        {
          ...
          price: 1580,
          desc:  { zh: '例 $1,580　半隻 $5,080　一隻 $10,080', en: 'Portion NT$1,580　Half NT$5,080　Whole NT$10,080', ja: '1皿 NT$1,580　ハーフ NT$5,080　1頭 NT$10,080' },
          image: '', youtube: '', badge: ['sig'],
        },
        {
          id: 'bbq-06',
          ...
          price: 760,
          desc:  { zh: '例 $760　半隻 $960　1隻 $1,880', en: 'Portion NT$760　Half NT$960　Whole NT$1,880', ja: '1皿 NT$760　ハーフ NT$960　1羽 NT$1,880' },
          image: '', youtube: '', badge: [],
        },
      ],
    },
