  ...
  categories: [
    ...
    // ── 私藏 ──────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        {
          id: 'hid-03',
          name: { zh: '大鴨藏珍寶（一天前預訂）', en: 'Fortune Eight-Treasure Duck (Pre-order 1 day)', ja: '縁起の珍宝アワビソース鴨詰め（1日前予約）' },
          price: 9880, unit: { zh: '一隻', en: 'Whole', ja: '1羽' },
          desc:  { zh: '材料：乾草菇・鮑魚・花膠・花菇・黃玉參　過敏源：軟體動物（鮑魚）', en: 'Ingredients: Dried Mushroom · Abalone · Fish Maw · Flower Mushroom · Sea Cucumber　Allergens: Mollusc (Abalone)', ja: '食材：乾燥きのこ・鮑魚・花膠・花しいたけ・なまこ　アレルゲン：軟体動物（アワビ）' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'hid-04',
