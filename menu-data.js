  ...
  categories: [
    ...
    // ── 點心 ──────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        {
          id: 'ds-08',
          name: { zh: '海皇天鵝酥（三件）', en: 'Crispy Purple Sweet Potato Puff (3 pcs)', ja: 'クリスピー紫芋パフ（3個）' },
          price: 360,
        ...
        {
          id: 'ds-09',
          name: { zh: '鮑魚雞粒酥（每件）', en: 'Abalone & Diced Chicken Shortcrust Pastry (each)', ja: 'アワビと鶏肉のサクサクタルト（1個）' },
          price: 360,
    ...
    // ── 燒味 ──────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        },
        {
          ...
          desc:  {
            zh: '捌伍叉燒皇・瑤柱貴妃雞・潮蓮靚燒鵝・化皮烤乳豬（加價 $200）　豬肉產地：台灣',
            en: '85TD Char Siu · Conpoy Poached Chicken · Teochew Roasted Goose · Crispy Suckling Pig (+NT$200)　Pork: Taiwan',
            ja: '叉焼皇・干し貝柱仕立て貴妃鶏・潮州焼きガチョウ・クリスピー仔豚ロースト（+NT$200）　豚肉産地：台湾',
          },
          image: '', youtube: '', badge: ['sig'],
        },
        {
    ...
    // ── 頭盤與小食 ────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        {
          id: 'st-03',
          name: { zh: '鮮沙薑凍豬手', en: "Chilled Pig's Trotter with Fresh Sand Ginger", ja: '砂ショウガ風味の冷製豚足ゼリー寄せ' },
          price: 520,
          desc:  { zh: '豬肉產地：台灣', en: 'Pork: Taiwan', ja: '豚肉産地：台湾' },
          image: '', youtube: '', badge: [],
        },
    ...
    // ── 家禽與肉類 ────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        },
        {
          ...
          price: null,
          desc:  { zh: '羊肉品牌：Lumina（紐西蘭）　過敏源：堅果（腰果）', en: 'Lamb: Lumina (New Zealand)　Allergens: Tree Nut (Cashew)', ja: 'ラム：Lumina（ニュージーランド）　アレルゲン：木の実（カシューナッツ）' },
          image: '', youtube: '', badge: ['sig'],
        },
      ],
    },
    ...
    // ── 飯麵類 ────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        },
        {
          ...
          price: null,
          desc:  {
            zh: '雞肉・蝦・蟹肉・蕃茄・四季豆・蔥・櫻花蝦・瑤柱　過敏源：蛋、甲殼類（蝦、櫻花蝦）、甲殼類（蟹)、軟體動物（瑤柱）',
            en: 'Chicken · Shrimp · Crab Meat · Tomato · Green Bean · Scallion · Sakura Shrimp · Conpoy　Allergens: Egg, Crustacean (Shrimp, Sakura Shrimp), Crustacean (Crab), Mollusc (Dried Scallop)',
            ja: '鶏肉・エビ・カニ肉・トマト・インゲン・ネギ・桜えび・干し貝柱　アレルゲン：卵・甲殻類（エビ・桜えび）・甲殻類（カニ）・軟体動物（干し貝柱）',
          },
          image: '', youtube: '', badge: ['sig'],
        },
        {
    ...
    // ── 甜點 ──────────────────────────────────────────────
    {
      ...
      dishes: [
        {
          id: 'des-02',
          name: { zh: '開心果奶凍（位上）', en: 'Pistachio Panna Cotta (per person)', ja: 'ピスタチオのパンナコッタ（1人前）' },
        ...
        {
          id: 'des-03',
          name: { zh: '楊汁甘露（位上）', en: 'Mango Pomelo Sago (per person)', ja: 'マンゴーポメロサゴ（楊枝甘露）（1人前）' },
          price: 260, perPerson: true,
          desc:  { zh: '', en: '', ja: '' },
          image: '', youtube: '', badge: ['veg'],
        },
        {
          id: 'des-04',
          name: { zh: '手磨杏仁茶湯圓（位上）', en: 'Hand-Ground Almond Milk Tea with Glutinous Rice Balls (per person)', ja: '手挽き杏仁茶と白玉団子（1人前）' },
          price: 260, perPerson: true,
