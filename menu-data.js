  ...
  categories: [
    ...
    // ── 湯羹類 ────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        {
          id: 'soup-03',
          name: { zh: '海鮮雪耳羹', en: 'Snow Fungus & Seafood Thick Soup', ja: '白きくらげ・海鮮のとろみスープ' },
          price: 380, perPerson: true,
          desc:  { zh: '過敏源：甲殼類（蝦）、軟體動物（帶子）、大豆（豆腐）', en: 'Allergens: Crustacean (Shrimp), Mollusc (Scallop), Soy (Tofu)', ja: 'アレルゲン：甲殻類（エビ）・軟体動物（帆立貝）・大豆（豆腐）' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'soup-04',
        ...
        {
          id: 'soup-07',
          name: { zh: '松茸清燉素獅子頭', en: "Clear-Braised Vegetarian Lion's Head", ja: '澄んだスープで炖た精進ライオンズヘッド' },
          price: 480, perPerson: true,
        ...
        {
          id: 'soup-08',
          name: { zh: '瑪卡瑤柱老雞燉海參', en: 'Double-Boiled Old Hen with Maca, Conpoy & Sea Cucumber', ja: 'マカ・干し貝柱・老鶏と海参の炖スープ' },
          price: 580, perPerson: true,
          desc:  { zh: '過敏源：軟體動物（瑤柱）、棘皮動物（海參）', en: 'Allergens: Mollusc (Conpoy), Echinoderm (Sea Cucumber)', ja: 'アレルゲン：軟体動物（干し貝柱）、棘皮動物（なまこ）' },
          image: '', youtube: '', badge: [],
        },
      ],
    },
    ...
    // ── 海鮮類 ────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        },
        {
          ...
          price: 300, perPerson: true,
          desc:  { zh: '過敏源：軟體動物（帶子）', en: 'Allergens: Mollusc (Scallop)', ja: 'アレルゲン：軟体動物（帆立貝）' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'sf-03',
          name: { zh: '花雕蛋白蒸龍蝦球', en: 'Steamed Lobster Fillet with Shaoxing Wine & Egg White', ja: '紹興酒と卵白蒸しロブスターの団子' },
        ...
        {
          id: 'sf-05',
          name: { zh: '豉椒鮮蘆筍炒青衣球', en: 'Stir-Fried Wrasse Fillet with Asparagus, Black Bean & Chili', ja: 'アスパラガス・豆豉・唐辛子炒めブダイの団子' },
          price: 980,
          desc:  { zh: '過敏源：魚類（青衣）、大豆（豆豉）', en: 'Allergens: Fish (Wrasse), Soy (Fermented Black Bean)', ja: 'アレルゲン：魚類（ブダイ）・大豆（豆豉）' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'sf-06',
          name: { zh: '上湯虎蝦粉絲煲', en: 'Superior Broth Tiger Prawns & Glass Noodle Casserole', ja: '上湯タイガーエビと春雨の土鍋煮込み' },
          price: 980,
        ...
        },
        {
          ...
          price: 680,
          desc:  { zh: '過敏源：軟體動物（中卷）、小麥（炸粉）', en: 'Allergens: Mollusc (Squid), Wheat (Batter)', ja: 'アレルゲン：軟体動物（ヤリイカ）・小麦（衣）' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'sf-12',
          name: { zh: '蒜蓉蒸青衣頭腩', en: 'Steamed Wrasse Head & Belly with Minced Garlic', ja: 'にんにく蒸しブダイの頭・腹身' },
          price: 880,
    ...
    // ── 家禽與肉類 ────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        },
        {
          ...
          price: 1580,
          desc:  { zh: '材料：當歸・北芪・杞子・紅棗　牛肉產地：台灣溫體', en: 'Ingredients: Angelica Root · Astragalus · Wolfberry · Red Date　Beef: Taiwan Fresh-Slaughtered', ja: '食材：当帰・黄耆・クコの実・なつめ　牛肉産地：台湾温体' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'main-11',
    ...
    // ── 飯麵類 ────────────────────────────────────────────
    {
      ...
      dishes: [
        ...
        },
        {
          ...
          price: 680,
          desc:  { zh: '牛肉產地：美國安格斯', en: 'Beef: US Angus', ja: '牛肉産地：米国アンガス' },
          image: '', youtube: '', badge: [],
        },
        {
          id: 'rice-04',
